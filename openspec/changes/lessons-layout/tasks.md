...
- [x] 8.1 `pnpm check` clean.
- [x] 8.2 `pnpm build && pnpm preview`: walk landing → tier → stage → lesson, back-button, direct URLs, Continue shortcut, and a browser with no history (empty rollups still navigate).
